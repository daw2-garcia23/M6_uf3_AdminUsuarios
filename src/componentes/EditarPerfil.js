                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer justify-content-center">
                                <button type="button" class="btn btn-success" id="btn-actualizar" >Actualizar perfil</button>
        ...
        for(let i = 0; i<adminUsuarios.array.length; i++){
            if(adminUsuarios.array[i].id == idArray){
                ...
                let html = `
                            ...
                            <td><button type="button" class="btn btn-primary editar mx-2" id="editar" data-id = "${adminUsuarios.array[i].id}" data-bs-toggle="modal" data-bs-target="#modal">Editar</button><button type="button" class="btn btn-danger mx-2 eliminar" data-id = "${adminUsuarios.array[i].id}">Eliminar</button></td>
                      `
                console.log(html);
